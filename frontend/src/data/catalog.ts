...
const META: Record<string, { priceFrom?: string; term?: string }> = {
  ...
  // Подтипы остальных разделов — цена «от» и срок для карточек категорий
  // (ТЗ страницы категории, блок 3). Заглушки; на проде — из прайс-листов CMS.
  '/foto-na-dokumenty/pasport-rf/': { priceFrom: 'от 300 ₽', term: 'за 5 минут' },
  '/foto-na-dokumenty/zagranpasport/': { priceFrom: 'от 350 ₽', term: 'за 5 минут' },
  '/foto-na-dokumenty/voditelskoe-udostoverenie/': { priceFrom: 'от 300 ₽', term: 'за 5 минут' },
  '/foto-na-dokumenty/medicinskaya-knizhka/': { priceFrom: 'от 300 ₽', term: 'за 5 минут' },
  '/foto-na-dokumenty/snils/': { priceFrom: 'от 300 ₽', term: 'за 5 минут' },
  '/foto-na-dokumenty/detskie-dokumenty/': { priceFrom: 'от 350 ₽', term: 'за 10 минут' },
  '/foto-na-dokumenty/viza/': { priceFrom: 'от 350 ₽', term: 'за 5 минут' },
  '/pechat-dokumentov/pechat-a4-a3/': { priceFrom: 'от 10 ₽/лист', term: 'за 1 час' },
  '/pechat-dokumentov/kopirovanie-a4-a3/': { priceFrom: 'от 8 ₽/лист', term: 'за 1 час' },
  '/pechat-dokumentov/broshyurovka/': { priceFrom: 'от 150 ₽', term: 'за 1 час' },
  '/pechat-dokumentov/tvyordyj-pereplet/': { priceFrom: 'от 700 ₽', term: '1–2 дня' },
  '/pechat-dokumentov/diplomnye-raboty/': { priceFrom: 'от 900 ₽', term: 'за 3 часа' },
  '/pechat-dokumentov/avtoreferaty/': { priceFrom: 'от 1 200 ₽', term: '1–2 дня' },
  '/pechat-dokumentov/laminirovanie/': { priceFrom: 'от 60 ₽', term: 'за 30 минут' },
  '/pechat-dokumentov/prezentacii/': { priceFrom: 'от 400 ₽', term: 'за 2 часа' },
  '/pechat-dokumentov/chertezhi/': { priceFrom: 'от 120 ₽', term: 'за 1 час' },
  '/fotopechat/pechat-fotografij/': { priceFrom: 'от 9 ₽', term: 'за 1 час' },
  '/fotopechat/pechat-na-holste/': { priceFrom: 'от 1 400 ₽', term: '2–3 дня' },
  '/fotopechat/postery-i-plakaty/': { priceFrom: 'от 350 ₽', term: '1–2 дня' },
  '/fotopechat/nakatka-na-penokarton/': { priceFrom: 'от 900 ₽', term: '1–2 дня' },
  '/fotoknigi/layflat/': { priceFrom: 'от 4 800 ₽', term: 'от 7 дней' },
  '/fotoknigi/softcover/': { priceFrom: 'от 2 400 ₽', term: 'от 5 дней' },
  '/fotoknigi/hardcover/': { priceFrom: 'от 3 400 ₽', term: 'от 6 дней' },
  '/fotoknigi/svadebnye/': { priceFrom: 'от 8 900 ₽', term: 'от 7 дней' },
  '/fotoknigi/vypusknye-albomy/': { priceFrom: 'от 2 900 ₽', term: 'от 10 дней' },
  '/fotoknigi/detskie/': { priceFrom: 'от 3 400 ₽', term: 'от 6 дней' },
  '/kalendari/nastennye/': { priceFrom: 'от 340 ₽', term: '3–5 дней' },
  '/kalendari/nastolnye/': { priceFrom: 'от 90 ₽', term: '2–3 дня' },
  '/kalendari/karmannye/': { priceFrom: 'от 4 ₽', term: '1–2 дня' },
  '/kalendari/foto/': { priceFrom: 'от 890 ₽', term: '3–5 дней' },
  '/kalendari/planingi/': { priceFrom: 'от 260 ₽', term: '3–5 дней' },
  '/naklejki/pechat/': { priceFrom: 'от 700 ₽', term: 'за 1 день' },
  '/naklejki/stikerpaki/': { priceFrom: 'от 1 500 ₽', term: '1–2 дня' },
  '/naklejki/etiketki/': { priceFrom: 'от 900 ₽', term: '1–2 дня' },
  '/naklejki/birki-dlya-odezhdy/': { priceFrom: 'от 1 100 ₽', term: '1–2 дня' },
  '/shirokoformat/bannery/': { priceFrom: 'от 700 ₽/м²', term: 'за 1 день' },
  '/shirokoformat/afishi-postery/': { priceFrom: 'от 190 ₽', term: 'за 1 день' },
  '/shirokoformat/interyernaya-pechat/': { priceFrom: 'от 900 ₽/м²', term: '1–2 дня' },
  '/shirokoformat/roll-up/': { priceFrom: 'от 5 900 ₽', term: '1–2 дня' },
  '/pechati-shtampy/avtomaticheskie/': { priceFrom: 'от 900 ₽', term: 'за 1 день' },
  '/pechati-shtampy/karmannye/': { priceFrom: 'от 700 ₽', term: 'за 1 день' },
  '/pechati-shtampy/faksimile/': { priceFrom: 'от 1 200 ₽', term: '1–2 дня' },
  '/pechati-shtampy/plombiratory/': { priceFrom: 'от 1 900 ₽', term: '2–3 дня' },
  '/suveniry/futbolki/': { priceFrom: 'от 900 ₽', term: '1–2 дня' },
  '/suveniry/kruzhki/': { priceFrom: 'от 450 ₽', term: '1–2 дня' },
