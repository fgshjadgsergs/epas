...
import { FileCheck2, Layers, Palette, Truck, Zap } from 'lucide-react';
...
const ITEMS = [
  ...
  {
    icon: Layers,
    title: 'Плотные материалы',
    text: 'Бумага 300–400 г, дизайнерские сорта, матовая и глянцевая ламинация, Soft Touch.',
  },
  {
    icon: Truck,
